...
### Open Tasks
- [ ] **SECURITY, NOW: remove the malware's Defender exclusions and the Allow entries.** Process stopped, Startup shortcut and payloads quarantined, Defender healthy (checked 08:05). Left: the four exclusions plus five threat IDs set to Allow, which need an admin PowerShell. See [[Security incident 2026-09-12]].
