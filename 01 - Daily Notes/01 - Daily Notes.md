...
- [[2026-09-26]]: VLC now opens on the Surface (cause: a stale skins2 interface setting); added a boot-config rule to always name the terminal for command blocks.
