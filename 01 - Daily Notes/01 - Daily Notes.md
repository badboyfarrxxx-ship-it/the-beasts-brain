...
- [[2026-09-26]]: VLC build test on the Surface in progress (extracted folder looked incomplete); added a boot-config rule to always name the terminal for command blocks.
