...
- [ ] **Replace the daisy-chained Genesys hubs with one powered USB 3 hub into the USB-C port.** Do this before moving `Program Files`/`Users` off the enclosure below — it's the fix for the exact power-drop that corrupted a drive on 09-01.
